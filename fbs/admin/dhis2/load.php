                                    ...
                                    <div id="paginationControls">
                                        <div class="d-flex align-items-center">
                                            <button type="button" class="btn btn-sm btn-outline-secondary" 
                                                    onclick="changePage(1)" id="firstPageBtn" disabled>
                                                <<
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-secondary ms-2" 
                                                    onclick="previousPage()" id="prevPageBtn" disabled>
                                                <
                                            </button>
                                            <span class="mx-2" id="currentPage">Group 1 of <?= $totalPages ?></span>
                                            <button type="button" class="btn btn-sm btn-outline-secondary" 
                                                    onclick="nextPage()" id="nextPageBtn" 
                                                    <?= $totalPages <= 1 ? 'disabled' : '' ?>>
                                                >
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-secondary ms-2" 
                                                    onclick="changePage(<?= $totalPages ?>)" id="lastPageBtn"
                                                    <?= $totalPages <= 1 ? 'disabled' : '' ?>>
                                                >>
                                            </button>
                                        </div>
